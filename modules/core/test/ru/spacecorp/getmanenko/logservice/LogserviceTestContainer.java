...
public class LogserviceTestContainer extends TestContainer {

    public LogserviceTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "ru/spacecorp/getmanenko/logservice/app.properties",
    ...
    public static class Common extends LogserviceTestContainer {

        public static final LogserviceTestContainer.Common INSTANCE = new LogserviceTestContainer.Common();
